...
<html>
	...
	<form action="register.php" method="POST">
		...
		<input type="text" placeholder="Telefon Nummer" name="phoneNumber" value="<?= $_SESSION['PhoneNumber'] ?>"><br>
		<input type="text" placeholder="Email (optional)" name="email" value="<?= $_SESSION['Email'] ?>"><br>
		<div>
			<input type="checkbox" id="dsvgo" name="dsvgo">
			<label for="dsvgo"><a href="dsvgo.php">Hiermit bestetige ich, dass ich die <b>Datenschutzbestimmungen</b> durchgelesen und verstanden habe. (Klicke hier um zu den Datenschutzbestimmungen zu kommen)</a></label>
		</div>
